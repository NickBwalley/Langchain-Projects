...
## Initialize HuggingFace Endpoint properly
repo_id = "mistralai/Mistral-7B-Instruct-v0.3"
# Pass temperature directly, and only max_length and token through model_kwargs
llm = HuggingFaceEndpoint(
    repo_id=repo_id,
    temperature=0.7,  # This parameter should be passed directly
    model_kwargs={
        "max_length": 150,
        "token": hf_api_key
    }
